...
$_telnumbers = 'tel:+421900111222';
$_email = 'mailto:email@mailinator.com';
		...
		<div class="contact-bar">
			<div class="container">
				<ul class="menu personal">
					<li><i class="fa fa-phone"></i><a href=" $_telnumbers ">+421 900 111 222</a></li>
					<li><i class="fa fa-envelope"></i><a href=" $_email ">email@mailinator.com</a></li>
				</ul>
...
?>
					<ul class="menu controls">
						<li data-from="left"><a href="?pageid=all.php">Všetko</a></li>
						<li data-from="right"><a href="?pageid=web.php">Web</a></li>
						<li data-from="left"><a href="?pageid=branding.php">Branding</a></li>
						<li data-from="right"><a href="?pageid=fotografia.php">Fotografia</a></li>
						<li data-from="left"><a href="?pageid=video.php">Video</a></li>
					</ul>
